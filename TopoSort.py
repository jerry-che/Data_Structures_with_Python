...
def main():
  ...
  for i in range (num_edges):
    ...
    print (edge)
    edge = edge.split()
    start = topo.get_index(edge[0])
    finish = topo.get_index(edge[1])

    topo.add_directed_edge (start, finish)


  print(topo.has_cycle())
  print("Topological Sort:")
  tsort = topo.topo_sort()
